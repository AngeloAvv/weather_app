...
import 'package:weather/pages/main/widgets/now_widget.dart';
                ...
                children: [
                  ...
                  if (forecast.first.snow != null)
                    SensorWidget(
                      ...
                      value:
                          '${forecast.first.snow?.threeHours.flatDouble} mm\u00B3',
                    ),
                  if (forecast.first.rain != null)
                    SensorWidget(
                      icon: const FaIcon(FontAwesomeIcons.cloudRain),
                      value:
                          '${forecast.first.rain?.threeHours.flatDouble} mm\u00B3',
                    ),
                  SensorWidget(
                    icon: const FaIcon(FontAwesomeIcons.binoculars),
                    value:
                        '${(forecast.first.visibility / 1000).flatDouble} Km',
                  ),
                ],
              ),
            ),
