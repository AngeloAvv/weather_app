...
/// A widget used on the main page to show the no internet error
class NoInternetErrorWidget extends StatelessWidget {
  ...
  /// The NoInternetErrorWidget constructor
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Container(height: 16),
            Text(
              context.l10n?.error_no_internet ?? 'error_no_internet',
              ...
              if (!searching)
                Padding(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(
                      context.l10n?.action_fix ?? 'action_fix',
                    ),
                    onPressed: onTap,
                  ),
                ),
